            ...
            <Reveal direction="right">
              ...
              <div className="relative glass-card p-8 md:p-12 rounded-3xl overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl md:text-3xl font-display font-medium text-white leading-snug mb-8">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-white font-semibold font-display">Premium Digital Asset</div>
