        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <Reveal>
            <div>
              ...
              <div className="p-6 rounded-2xl bg-primary/5 border border-primary/20 text-white/90 text-sm leading-relaxed mb-10">
            ...
            <div className="glass-card p-8 md:p-12 rounded-3xl space-y-8">
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <div className="text-xl font-semibold text-white">Holtek Solutions LLC</div>
              ...
              <div className="flex flex-col sm:flex-row gap-8">
                <a href="tel:+19515514528" className="flex items-start gap-5 group">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-medium text-white group-hover:text-primary transition-colors">
                      +1 (951) 551-4528
                    </div>
                  </div>
                </a>
